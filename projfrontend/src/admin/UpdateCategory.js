...
const AddCategory=()=>{
    ...
    const warningMessage=()=>{
        if(error){
            return <h4 className="text-success">Category updated failed successfully</h4>
        }
    };
    ...
    const myCategoryForm=()=>(
        <form>
            <div className="form-group">
                ...
                <input onChange={handleChange} value={name} type="text" className="form-control my-3" autoFocus required />
    ...
    return(
        ...
        description="Update a category for new tshirts" 
